...
| **v0.6C** | **In progress: governed corpus, rights review, XML extraction and deterministic blinded annotation sampling implemented; independent labels, training, evaluation and promotion remain** |
