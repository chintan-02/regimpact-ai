...
| **v0.6C** | **In progress: governed corpus, rights review, XML extraction, deterministic blinded sampling and secure offline annotation workspaces implemented; independent labels, training, evaluation and promotion remain** |
